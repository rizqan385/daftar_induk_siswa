...
// @Description Update achievement record
// @Tags Prestasi
// @Accept json
// @Produce json
// @Param id path int true "Achievement Record ID"
// @Param request body requests.CreatePrestasiRequest true "Achievement data"
// @Success 200 {object} utils.Response{data=responses.PrestasiResponse}
// @Failure 400 {object} utils.Response
// @Failure 404 {object} utils.Response
// @Security BearerAuth
// @Router /prestasi/{id} [put]
func (h *PrestasiHandler) Update(c *gin.Context) {
	...
	utils.SuccessResponse(c, "Achievement record updated successfully", response)
}
